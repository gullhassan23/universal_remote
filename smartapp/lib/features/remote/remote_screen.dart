...
import 'package:smartapp/widgets/volumetile.dart';
...
class RemoteScreen extends GetView<RemoteController> {
  ...
  static const String _screenName = 'Remote_Screen';
  ...
  Widget build(BuildContext context) {
    const RemoteWallpaperButtonAssets activeButtonAssets =
        RemoteWallpaper6ButtonAssets.set;
    unawaited(
      _analyticsService.logScreen(
        screenName: _screenName,
        screenClass: 'RemoteScreen',
      ),
    );
    return Scaffold(
      ...
      body: Container(
        decoration: const BoxDecoration(
          ...
          image: DecorationImage(
            image: AssetImage(RemoteWallpaperAssets.wallpaper),
            fit: BoxFit.cover,
          ),
        ),
        child: SafeArea(
          ...
          Positioned.fill(
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  VolumeRailIcon(
                    asset: buttonAssets.plus,
                    ontap: _sendKeyTap('KEY_VOLUP'),
                  ),
                  VolumeRailIcon(
                    asset: buttonAssets.sound,
                    ontap: _sendKeyTap('KEY_MUTE'),
                  ),
                  VolumeRailIcon(
                    asset: buttonAssets.minus,
  ...
  Widget _buildAdaptiveDpad(RemoteWallpaperButtonAssets? buttonAssets) {
    return LayoutBuilder(
      builder: (context, c) {
        // Keep some breathing room so the circle never "squeezes" visually.
