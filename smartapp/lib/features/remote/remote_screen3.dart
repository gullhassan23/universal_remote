...
class RemoteScreen3 extends GetView<RemoteController> {
  RemoteScreen3({super.key});
      ...
      body: Container(
        decoration: const BoxDecoration(
          ...
          image: DecorationImage(
            image: AssetImage(RemoteWallpaperAssets.wallpaper3),
            fit: BoxFit.cover,
          ),
        ),
        child: SafeArea(
  ...
  Widget _buildVolumeColumn(RemoteWallpaperButtonAssets? buttonAssets) {
    // Keep the rail width tighst to avoid extra blank space in the Row.
